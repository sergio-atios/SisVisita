# 🚶 SisPorta - Sistema de Registro Porta em Porta
...
1. **Criar repositório no GitHub**
   ...
   - Nome: `sisporta` (ou qualquer nome)
   - Marque: ✅ Public
...
4. **Pronto!** Seu link será:
   ```
   https://SEU-USUARIO.github.io/sisporta/
   ```
...
2. Banner aparecerá: "Adicionar SisPorta à tela inicial"
